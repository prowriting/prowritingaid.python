...
class HtmlApi(object):
    ...
    def get_with_http_info(self, task_id, **kwargs):
        ...
        return self.api_client.call_api('/api/async/html/result/{taskId}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='AsyncResponseHtmlAnalysisResponse',
    ...
    def post(self, requestp, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param HtmlAnalysisRequest requestp:  (required)
        :return: AsyncResponseHtmlAnalysisResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def post_with_http_info(self, requestp, **kwargs):
        ...
        return self.api_client.call_api('/api/async/html', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
