...
class SummaryApi(object):
    ...
    def get_with_http_info(self, task_id, **kwargs):
        ...
        return self.api_client.call_api('/api/async/summary/result/{taskId}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='AsyncResponseSummaryAnalysisResponse',
    ...
    def post_with_http_info(self, requestp, **kwargs):
        ...
        return self.api_client.call_api('/api/async/summary', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
