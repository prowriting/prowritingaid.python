...
class TextApi(object):
    ...
    def get_with_http_info(self, task_id, **kwargs):
        ...
        return self.api_client.call_api('/api/async/text/result/{taskId}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='AsyncResponseTextAnalysisResponse',
    ...
    def post(self, requestp, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param TextAnalysisRequest requestp:  (required)
        :return: AsyncResponseTextAnalysisResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def post_with_http_info(self, requestp, **kwargs):
        ...
        return self.api_client.call_api('/api/async/text', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
