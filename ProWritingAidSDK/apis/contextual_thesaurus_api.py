...
class ContextualThesaurusApi(object):
    """
    ...
    def get_with_http_info(self, task_id, **kwargs):
        ...
        return self.api_client.call_api('/api/async/contextualthesaurus/result/{taskId}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
                                        ...
                                        response_type='AsyncResponseContextualThesaurusResponse',
    ...
    def post(self, requestp, **kwargs):
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :param ContextualThesaurusRequest requestp: (required)
        :return: AsyncResponseContextualThesaurusResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def post_with_http_info(self, requestp, **kwargs):
        ...
        return self.api_client.call_api('/api/async/contextualthesaurus', 'POST',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
